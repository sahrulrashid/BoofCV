 ...
 * @author Peter Abeles
 */
public class GenerateMetricCameraTripleDualQuadratic implements ModelGenerator<MetricCameraTriple, AssociatedTriple> {
	...
	public GenerateMetricCameraTripleDualQuadratic(Estimate1ofTrifocalTensor trifocal,
												   SelfCalibrationLinearDualQuadratic selfCalib) {
		this.trifocal = trifocal;
		this.selfCalib = selfCalib;
	}

	protected GenerateMetricCameraTripleDualQuadratic() {}
