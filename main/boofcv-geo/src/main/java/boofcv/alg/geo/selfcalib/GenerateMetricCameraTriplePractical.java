 ...
 * @author Peter Abeles
 */
public class GenerateMetricCameraTriplePractical implements ModelGenerator<MetricCameraTriple, AssociatedTriple> {
	...
	public GenerateMetricCameraTriplePractical(Estimate1ofTrifocalTensor trifocal, SelfCalibrationGuessAndCheckFocus alg) {
		this.trifocal = trifocal;
		this.alg = alg;
	}

	protected GenerateMetricCameraTriplePractical() {}
